...
LOG_FILE = os.path.join(LOG_DIR, 'migrador_organoleptico.log')
...
class MigradorOrganoleptico:
    def __init__(self, fecha: datetime, almacen_id: str):
        ...
        # Tablas objetivo para organoleptico
    ...
    def _construir_queries(self):
        ...
        # QUERY PRINCIPAL ORGANOLEPTICO
        consulta_organoleptico = f"""
        SELECT
        ...
        """
        return {
            'ORGANOLEPTICO': consulta_organoleptico,
            'OWHS': consulta_owhs
        }
        ...
        try:
            ...
            with ConexionHANA(query) as hana:
                ...
                if tabla_sql == 'ORGANOLEPTICO':
                    # Logica especifica ORGANOLEPTICO
                    importador = ImportadorOrganoleptico()
                    ...
                    with ConexionSQL() as sql:
                        ...
                        logger.info(f"Proceso ORGANOLEPTICO finalizado. Registros origen: {total}")
                        return total
